defmodule WarbandTrackerWeb.CoreComponents do
  @moduledoc """
  ...
  def simple_form(assigns) do
    ...
    <.form :let={f} for={@for} as={@as} {@rest}>
      <div class="space-y-8 bg-gray-50 mt-10">
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(WarbandTrackerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(WarbandTrackerWeb.Gettext, "errors", msg, opts)
    end
  end
